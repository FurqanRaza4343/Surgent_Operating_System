...
import { ActivityIcon, MenuIcon, XIcon, ArrowRightIcon } from "lucide-react";
    ...
    <header
      ...
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4 sm:px-8">
        ...
        <div className="hidden items-center gap-3 lg:flex">
          ...
          <a
            href="#demo"
            className="group inline-flex items-center gap-2 rounded-full bg-teal-600 px-5 py-2.5 text-sm font-semibold text-white shadow-soft transition-all hover:bg-teal-700">
