...
import { InstagramIcon, FacebookIcon, LinkedinIcon, MessageCircleIcon } from "lucide-react";

const CHANNELS = [
{ icon: InstagramIcon, name: "Instagram", detail: "DMs, comments & story replies", color: "#D6336C" },
{ icon: MessageCircleIcon, name: "WhatsApp", detail: "Chats, reminders & follow-ups", color: "#25D366" },
{ icon: FacebookIcon, name: "Facebook", detail: "Messenger & lead ads", color: "#1877F2" },
{ icon: LinkedinIcon, name: "LinkedIn", detail: "Inbound outreach & referrals", color: "#0A66C2" }];
        ...
        <div className="grid items-center gap-14 lg:grid-cols-2">
          ...
          <motion.div
            ...
            <div className="flex items-center gap-2 border-b border-sand-100 pb-4">
              <InstagramIcon className="h-5 w-5 text-[#D6336C]" />
